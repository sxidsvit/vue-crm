...
export default {
  ...
  async mounted() {
    ...
    setTimeout(() => {
      // инициализируем  инстанс materializecss.com обслуживающий select
      this.select = M.FormSelect.init(this.$refs.select)
      // повторная инициализация инпутов после обновления страницы
      M.updateTextFields()
    }, 0)
  },
  computed: {
  ...
  destroyed() {
    // удаляем инстанс materializecss.com обслуживающий select
